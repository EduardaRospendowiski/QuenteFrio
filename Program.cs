...
while (numeroTentativas < 7 && !acertou)
{
    ...
    if (diferenca <= 3){
        ...
        Console.WriteLine($"{dica} O número é {(palpite < numeroSorteado ? "maior" : "menor")} do que o palpite.\n");
    }
}
...
if (!acertou)
{
    ...
    Console.WriteLine($"O número era: {numeroSorteado}\n");
}

Console.WriteLine("Fim do jogo. Obrigado por tentar!\n");
